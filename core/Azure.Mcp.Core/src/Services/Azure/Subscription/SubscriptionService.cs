    ...
    : BaseAzureService(tenantService), ISubscriptionService
{
    ...
    public async Task<List<SubscriptionData>> GetSubscriptions(McpUserContext userContext, string? tenant = null, RetryPolicyOptions? retryPolicy = null)
    {
    ...
    public async Task<SubscriptionResource> GetSubscription(McpUserContext userContext, string subscription, string? tenant = null, RetryPolicyOptions? retryPolicy = null)
    {
        ValidateRequiredParameters(subscription);

        // Get the subscription ID first, whether the input is a name or ID
        var subscriptionId = await GetSubscriptionId(userContext, subscription, tenant, retryPolicy);
    ...
    public async Task<string> GetSubscriptionIdByName(McpUserContext userContext, string subscriptionName, string? tenant = null, RetryPolicyOptions? retryPolicy = null)
    {
        var subscriptions = await GetSubscriptions(userContext, tenant, retryPolicy);
    ...
    public async Task<string> GetSubscriptionNameById(McpUserContext userContext, string subscriptionId, string? tenant = null, RetryPolicyOptions? retryPolicy = null)
    {
        var subscriptions = await GetSubscriptions(userContext, tenant, retryPolicy);
    ...
    private async Task<string> GetSubscriptionId(McpUserContext userContext, string subscription, string? tenant, RetryPolicyOptions? retryPolicy)
    {
        ...
        return await GetSubscriptionIdByName(userContext, subscription, tenant, retryPolicy);
    }
}
