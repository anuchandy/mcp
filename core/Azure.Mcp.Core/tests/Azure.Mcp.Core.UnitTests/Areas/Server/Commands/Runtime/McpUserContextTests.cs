...
public class McpUserContextTests
{
    ...
    [Fact]
    public void HasUserIdentity_WithTenantId_ReturnsTrue()
    {
        // Arrange
        var context = new McpUserContext("tenant-123", null, null, AzRuntimeMode.Default);

        // Act & Assert
        Assert.True(context.HasUserIdentity);
    }

    [Fact]
    public void HasUserIdentity_WithUserObjectId_ReturnsTrue()
    {
        // Arrange
        var context = new McpUserContext(null, "user-456", null, AzRuntimeMode.Default);
    ...
    [Fact]
    public void HasUserIdentity_WithSerializedClaimsPrincipal_ReturnsTrue()
    {
        // Arrange
        var context = new McpUserContext(null, null, "dGVzdA==", AzRuntimeMode.Default);
    ...
    [Fact]
    public void HasUserIdentity_WithNoIdentity_ReturnsFalse()
    {
        // Arrange
        var context = McpUserContext.Empty;

        // Act & Assert
        Assert.False(context.HasUserIdentity);
    }

    [Fact]
    public void SupportsOboFlow_WithOboParentAndIdentity_ReturnsTrue()
    {
        // Arrange
        var context = new McpUserContext("tenant-123", "user-456", null, AzRuntimeMode.OboParent);

        // Act & Assert
        Assert.True(context.SupportsOboFlow);
    }

    [Fact]
    public void SupportsOboFlow_WithOboChildAndIdentity_ReturnsTrue()
    {
        // Arrange
        var context = new McpUserContext("tenant-123", "user-456", null, AzRuntimeMode.OboChild);
    ...
    [Fact]
    public void SupportsOboFlow_WithDefaultMode_ReturnsFalse()
    {
        // Arrange
        var context = new McpUserContext("tenant-123", "user-456", null, AzRuntimeMode.Default);

        // Act & Assert
        Assert.False(context.SupportsOboFlow);
    }

    [Fact]
    public void SupportsOboFlow_WithOboModeButNoIdentity_ReturnsFalse()
    {
        // Arrange
        var context = new McpUserContext(null, null, null, AzRuntimeMode.OboParent);
